...
<style>
	#header-container #header {
		background: rgba(38, 38, 38, 0.12) none repeat scroll 0 0;
	}
	.info-box-title, .feature-title, .description{font-family: "GothamLight" !important; font-weight: 100;}
	...
	body, div, dl, dt, dd, ul, ol, li, h1, h2, h3, h4, h5, h6, pre, form, p, blockquote, th, td,.wpb_wrapper h3.widget-title,.nav-menu .mega-menu-item .item-title{font-family: "GothamLight" !important;}
	* {
...
.row .social-left, .row .socail-right {width: 38.444%;}
#header-container #header .header-wrap > .row:last-child .header-main-panel .header-col-fluid {
    padding: 0 5px !important;
}
.nav-menu .mega-menu-item .item-title {padding: 0 15px !important;}
.alzheimer {background-size:100% 100% !important;}
.sliderlogo {top:80px !important; padding-bottom: 80px !important;}
</style>
