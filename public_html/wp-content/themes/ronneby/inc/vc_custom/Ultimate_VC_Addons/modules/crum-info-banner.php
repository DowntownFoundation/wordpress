...
if ( ! class_exists( 'Dfd_Info_Banner' ) ) {
	...
	class Dfd_Info_Banner {
		...
		function __construct() {
			add_action( 'vc_before_init', array( &$this, 'dfd_info_banner_init' ) );
		...
		function dfd_info_banner_init() {
			...
			if ( function_exists( 'vc_map' ) ) {
				...
				$module_images = get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/info_banner/';
