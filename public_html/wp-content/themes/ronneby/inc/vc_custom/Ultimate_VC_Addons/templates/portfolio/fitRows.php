	...
	<div class="dfd-portfolio-wrap">
		<?php
			if($sort_panel_enabled)
				include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/portfolio/template_parts/sort-panel.php'));
		?>
		...
		<?php
			while ($wp_query->have_posts()) : $wp_query->the_post();
				...
				if($sort_panel_enabled)
					include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/portfolio/template_parts/article_data_atts.php'));
				?>
				<div class="<?php echo esc_attr($post_class) ?>" <?php echo $article_data_atts; ?>>
					<div class="cover <?php echo esc_attr($content_alignment) ?>">
						...
						<div class="entry-thumb <?php echo esc_attr($media_class) ?>">
							...
							<?php include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/portfolio/template_parts/comments_likes.php')); ?>
							<?php include(locate_template('templates/portfolio/custom-hover.php')); ?>
						</div>


						<?php include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/portfolio/template_parts/heading.php')); ?>
