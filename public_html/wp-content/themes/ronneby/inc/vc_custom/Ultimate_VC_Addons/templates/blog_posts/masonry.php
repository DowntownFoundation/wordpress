...
<div class="dfd-blog-loop dfd-blog-posts-module <?php echo esc_attr($el_class) ?>" id="<?php echo esc_attr($uniqid) ?>">
	<div class="dfd-blog-wrap">
		<?php
			if($sort_panel)
				include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/blog_posts/template_parts/sort-panel.php'));
		?>
		...
		<?php
			...
			while ($wp_query->have_posts()) : $wp_query->the_post();
				...
				if($sort_panel)
					include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/blog_posts/template_parts/article_data_atts.php'));
				?>
				<div class="<?php echo esc_attr($post_class) ?>" <?php echo $article_data_atts; ?>>
					<div class="cover">
						<?php
						if($heading_position == 'top' || $post_format == 'quote')
							include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/blog_posts/template_parts/heading.php'));
						...
						<?php
							if($post_format && in_array($post_format, $avail_post_formats)) {
								...
								include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/blog_posts/template_parts/comments_likes.php'));
							} else {
								...
								?>
									<div class="entry-thumb">
										...
										<?php include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/blog_posts/template_parts/comments_likes.php')); ?>
									</div>
								<?php
							}
						?>
