...
class WC_Fedex_Freight_Mapping {
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_shipping_classes_columns', array( $this, 'woocommerce_shipping_classes_columns' ) );
		add_action( 'woocommerce_shipping_classes_column_fedex-freight-class', array( $this, 'freight_class_column_html' ) );
		add_action( 'woocommerce_shipping_classes_save_class', array( $this, 'woocommerce_shipping_classes_save_class' ), 10, 2 );
	}
	 ...
	 * @return array
	 */
	public function woocommerce_get_shipping_classes( $classes ) {
	 ...
	 */
	public function freight_class_column_html() {
		?>
	...
	public function woocommerce_shipping_classes_save_class( $term_id, $data ) {
		if ( $term_id && isset( $data['fedex_freight_class'] ) ) {
			update_woocommerce_term_meta( $term_id, 'fedex_freight_class', sanitize_text_field( $data['fedex_freight_class'] ) );
		}
	}
